...
export const Projects = () => {
    ...
    const [activeCategory, setActiveCategory] = useState<'All' | 'Major Projects' | 'Projects'>('All');
    ...
    const filteredProjects = useMemo(() => {
        return allProjects.filter(project => {
            ...
            const matchDivision = activeDivision === 'All' || project.divisionSlug === activeDivision;
            ...
            <div className="bg-neutral-dark text-white pt-32 pb-16">
                <div className="container-custom">
                    ...
                    <p className="text-xl text-neutral-400 max-w-2xl">
                        A portfolio of successful ground engineering challenges solved across the UAE and region.
                    </p>
                </div>
            </div>
                ...
                <div className="container-custom flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        <button
                            ...
                            className={clsx("px-4 py-2 rounded-full text-sm font-medium transition-colors", activeDivision === 'All' ? "bg-primary text-white" : "bg-neutral-100 text-neutral-600 hover:bg-neutral-200")}
                        >
                            All Divisions
                        </button>
                        {divisions.map(div => (
                            <button
                                ...
                                className={clsx("px-4 py-2 rounded-full text-sm font-medium transition-colors", activeDivision === div.slug ? "bg-primary text-white" : "bg-neutral-100 text-neutral-600 hover:bg-neutral-200")}
                            >
                                {div.name}
                            </button>
                        ))}
                ...
                <div className="container-custom">
                    {filteredProjects.length === 0 ? (
                        <div className="text-center py-20 text-neutral-500">
                            ...
                            <Button variant="ghost" className="mt-4" onClick={() => { setActiveDivision('All'); setActiveCategory('All'); setSearchQuery(''); }}>
                                Clear Filters
                            </Button>
                        </div>
                    ) : (
