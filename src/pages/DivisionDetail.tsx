    ...
    if (!division) {
        return (
            <div className="pt-32 pb-20 container-custom text-center">
                ...
                <Link to="/divisions" className="text-primary hover:underline mt-4 inline-block">Back to Divisions</Link>
            </div>
        );
    }
        ...
        <>
            ...
            <div className="relative h-[60vh] min-h-[500px] flex items-center">
                ...
                <div className="container-custom relative z-20 text-white">
                    <Link to="/divisions" className="text-white/60 hover:text-white mb-4 inline-flex items-center text-sm font-bold uppercase tracking-widest">
                        <ArrowRight className="rotate-180 mr-2" size={16} /> All Divisions
                    </Link>
                    <h1 className="text-5xl md:text-7xl font-display font-bold mb-6">{division.name}</h1>
                    <p className="text-xl md:text-2xl text-neutral-200 max-w-3xl leading-relaxed font-light mb-10">
                        {division.summary}
                    </p>
                    <Button onClick={() => window.location.href = '/contact'}>Discuss {division.name} Scope</Button>
                </div>
            </div>
            ...
            <div className="bg-primary-dark text-white py-24">
                <div className="container-custom text-center">
                    ...
                    <p className="text-neutral-300 mb-10 max-w-2xl mx-auto">
                        Contact our {division.name} experts today for a technical consultation and proposal.
                    </p>
                    <Button variant="white" size="lg" onClick={() => window.location.href = '/contact'}>Get in Touch</Button>
                </div>
            </div>
        </>
    );
