    ...
    return (
        <div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden">
                            ...
                            <tr key={project.id} className="hover:bg-neutral-50 transition-colors">
                                <td className="p-4 font-medium text-primary flex items-center">
                                    <span
                                        ...
                                        style={{ backgroundColor: getDivisionColor(project.divisionSlug) }}
                                ...
                                <td className="p-4 text-right space-x-2">
                                    <Link to={`/admin/projects/${project.id}/edit`} className="inline-block p-2 text-neutral-400 hover:text-accent">
                                        <Edit2 size={16} />
                                    </Link>
                                    <button onClick={() => deleteProject(project.id)} className="inline-block p-2 text-neutral-400 hover:text-red-500">
                                        <Trash2 size={16} />
                                    </button>
                                </td>
                            </tr>
                ...
                {projects.length === 0 && <div className="p-8 text-center text-neutral-400">No projects found.</div>}
            </div>
        </div>
    );
};
