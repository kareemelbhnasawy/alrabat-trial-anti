...
export const ProjectCard = ({ project }: ProjectCardProps) => {
    ...
    return (
        <Link to={`/projects/${project.slug}`} className="group block h-full bg-white rounded-lg shadow-sm hover:shadow-xl transition-all duration-300 relative overflow-hidden flex flex-col">
            {/* Image Section */}
