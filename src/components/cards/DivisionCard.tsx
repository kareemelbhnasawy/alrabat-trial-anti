...
export const DivisionCard = ({ division, index }: DivisionCardProps) => {
  return (
    <div className="relative group h-full">
      <div className="absolute inset-0 rounded-lg translate-x-2.5 translate-y-2.5 opacity-0 group-hover:opacity-100 transition-all duration-300 z-0 border border-neutral-300 bg-neutral-200" />
      <Link
